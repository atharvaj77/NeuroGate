...
from neurogate.api_client import ApiClient, RequestSerialized
from neurogate.api_response import ApiResponse
from neurogate.rest import RESTResponseType
...
class DefaultApi:
    ...
    def replay_session(
        ...
        replay_options: Optional[ReplayOptions] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type session_id: str
        :param replay_options:
        :type replay_options: ReplayOptions
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._replay_session_serialize(
    ...
    @validate_call
    def replay_session_with_http_info(
        self,
        session_id: StrictStr,
        replay_options: Optional[ReplayOptions] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def replay_session_without_preload_content(
        self,
        session_id: StrictStr,
        replay_options: Optional[ReplayOptions] = None,
        _request_timeout: Union[
    ...
    def _replay_session_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/debug/sessions/{sessionId}/replay',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
